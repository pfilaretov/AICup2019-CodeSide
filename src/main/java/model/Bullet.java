...
public class Bullet {
    ...
    public model.WeaponType getWeaponType() {
        return weaponType;
    }

    public void setWeaponType(model.WeaponType weaponType) {
    ...
    public model.Vec2Double getPosition() {
        return position;
    }

    public void setPosition(model.Vec2Double position) {
        this.position = position;
    }

    private model.Vec2Double velocity;

    public model.Vec2Double getVelocity() {
        return velocity;
    }

    public void setVelocity(model.Vec2Double velocity) {
    ...
    public model.ExplosionParams getExplosionParams() {
        return explosionParams;
    }

    public void setExplosionParams(model.ExplosionParams explosionParams) {
    ...
    public Bullet(model.WeaponType weaponType, int unitId, int playerId, model.Vec2Double position,
                  model.Vec2Double velocity, int damage, double size, model.ExplosionParams explosionParams) {
        this.weaponType = weaponType;
        this.unitId = unitId;
        this.playerId = playerId;
        this.position = position;
