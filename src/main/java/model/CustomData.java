...
public abstract class CustomData {
    ...
    public static class Rect extends CustomData {
        ...
        public model.Vec2Float getPos() {
            return pos;
        }

        public void setPos(model.Vec2Float pos) {
            this.pos = pos;
        }

        private model.Vec2Float size;

        public model.Vec2Float getSize() {
            return size;
        }

        public void setSize(model.Vec2Float size) {
            this.size = size;
        }

        private model.ColorFloat color;

        public model.ColorFloat getColor() {
            return color;
        }

        public void setColor(model.ColorFloat color) {
            this.color = color;
        }
    ...
    public static class Line extends CustomData {
        ...
        public model.Vec2Float getP1() {
            return p1;
        }

        public void setP1(model.Vec2Float p1) {
            this.p1 = p1;
        }

        private model.Vec2Float p2;

        public model.Vec2Float getP2() {
            return p2;
        }

        public void setP2(model.Vec2Float p2) {
            this.p2 = p2;
        }
    ...
    public static class PlacedText extends CustomData {
        ...
        public model.TextAlignment getAlignment() {
            return alignment;
        }

        public void setAlignment(model.TextAlignment alignment) {
        ...
        public PlacedText(String text, model.Vec2Float pos, model.TextAlignment alignment, float size,
                          model.ColorFloat color) {
            this.text = text;
            this.pos = pos;
            this.alignment = alignment;
            this.size = size;
