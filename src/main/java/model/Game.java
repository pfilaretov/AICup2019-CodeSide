...
public class Game {
    ...
    public model.Unit[] getUnits() {
        return units;
    }

    public void setUnits(model.Unit[] units) {
        this.units = units;
    }

    private model.Bullet[] bullets;

    public model.Bullet[] getBullets() {
        return bullets;
    }

    public void setBullets(model.Bullet[] bullets) {
        this.bullets = bullets;
    }

    private model.Mine[] mines;

    public model.Mine[] getMines() {
        return mines;
    }

    public void setMines(model.Mine[] mines) {
        this.mines = mines;
    }

    private model.LootBox[] lootBoxes;

    public model.LootBox[] getLootBoxes() {
        return lootBoxes;
    }

    public void setLootBoxes(model.LootBox[] lootBoxes) {
    ...
    public Game(int currentTick, model.Properties properties, model.Level level, model.Player[] players,
                model.Unit[] units, model.Bullet[] bullets, model.Mine[] mines, model.LootBox[] lootBoxes) {
        this.currentTick = currentTick;
        this.properties = properties;
        this.level = level;
        this.players = players;
