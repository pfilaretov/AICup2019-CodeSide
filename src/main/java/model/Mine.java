...
public class Mine {
    ...
    public void setState(model.MineState state) {
        this.state = state;
    }
    ...
    public Mine(int playerId, model.Vec2Double position, model.Vec2Double size, model.MineState state, Double timer,
                double triggerRadius, model.ExplosionParams explosionParams) {
        this.playerId = playerId;
        this.position = position;
        this.size = size;
        this.state = state;
