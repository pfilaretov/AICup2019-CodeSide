...
public class Properties {
    ...
    public model.Vec2Double getLootBoxSize() {
        return lootBoxSize;
    }

    public void setLootBoxSize(model.Vec2Double lootBoxSize) {
        this.lootBoxSize = lootBoxSize;
    }

    private model.Vec2Double unitSize;

    public model.Vec2Double getUnitSize() {
        return unitSize;
    }

    public void setUnitSize(model.Vec2Double unitSize) {
        this.unitSize = unitSize;
    }

    private double unitMaxHorizontalSpeed;

    public double getUnitMaxHorizontalSpeed() {
        return unitMaxHorizontalSpeed;
    }

    public void setUnitMaxHorizontalSpeed(double unitMaxHorizontalSpeed) {
        this.unitMaxHorizontalSpeed = unitMaxHorizontalSpeed;
    }

    private double unitFallSpeed;

    public double getUnitFallSpeed() {
        return unitFallSpeed;
    }

    public void setUnitFallSpeed(double unitFallSpeed) {
        this.unitFallSpeed = unitFallSpeed;
    }

    private double unitJumpTime;

    public double getUnitJumpTime() {
        return unitJumpTime;
    }

    public void setUnitJumpTime(double unitJumpTime) {
        this.unitJumpTime = unitJumpTime;
    }

    private double unitJumpSpeed;

    public double getUnitJumpSpeed() {
        return unitJumpSpeed;
    }

    public void setUnitJumpSpeed(double unitJumpSpeed) {
        this.unitJumpSpeed = unitJumpSpeed;
    }

    private double jumpPadJumpTime;

    public double getJumpPadJumpTime() {
        return jumpPadJumpTime;
    }

    public void setJumpPadJumpTime(double jumpPadJumpTime) {
        this.jumpPadJumpTime = jumpPadJumpTime;
    }

    private double jumpPadJumpSpeed;

    public double getJumpPadJumpSpeed() {
        return jumpPadJumpSpeed;
    }

    public void setJumpPadJumpSpeed(double jumpPadJumpSpeed) {
    ...
    public void setUnitMaxHealth(int unitMaxHealth) {
    ...
    public void setHealthPackHealth(int healthPackHealth) {
        this.healthPackHealth = healthPackHealth;
    }

    private java.util.Map<model.WeaponType, model.WeaponParams> weaponParams;

    public java.util.Map<model.WeaponType, model.WeaponParams> getWeaponParams() {
        return weaponParams;
    }

    public void setWeaponParams(java.util.Map<model.WeaponType, model.WeaponParams> weaponParams) {
        this.weaponParams = weaponParams;
    }

    private model.Vec2Double mineSize;

    public model.Vec2Double getMineSize() {
        return mineSize;
    }

    public void setMineSize(model.Vec2Double mineSize) {
        this.mineSize = mineSize;
    }

    private model.ExplosionParams mineExplosionParams;

    public model.ExplosionParams getMineExplosionParams() {
        return mineExplosionParams;
    }

    public void setMineExplosionParams(model.ExplosionParams mineExplosionParams) {
        this.mineExplosionParams = mineExplosionParams;
    }

    private double minePrepareTime;

    public double getMinePrepareTime() {
        return minePrepareTime;
    }

    public void setMinePrepareTime(double minePrepareTime) {
        this.minePrepareTime = minePrepareTime;
    }

    private double mineTriggerTime;

    public double getMineTriggerTime() {
        return mineTriggerTime;
    }

    public void setMineTriggerTime(double mineTriggerTime) {
        this.mineTriggerTime = mineTriggerTime;
    }

    private double mineTriggerRadius;

    public double getMineTriggerRadius() {
        return mineTriggerRadius;
    }

    public void setMineTriggerRadius(double mineTriggerRadius) {
    ...
    public Properties(int maxTickCount, int teamSize, double ticksPerSecond, int updatesPerTick,
                      model.Vec2Double lootBoxSize, model.Vec2Double unitSize, double unitMaxHorizontalSpeed,
                      double unitFallSpeed, double unitJumpTime, double unitJumpSpeed, double jumpPadJumpTime,
                      double jumpPadJumpSpeed, int unitMaxHealth, int healthPackHealth,
                      java.util.Map<model.WeaponType, model.WeaponParams> weaponParams, model.Vec2Double mineSize,
                      model.ExplosionParams mineExplosionParams, double minePrepareTime, double mineTriggerTime,
                      double mineTriggerRadius, int killScore) {
        this.maxTickCount = maxTickCount;
        this.teamSize = teamSize;
        this.ticksPerSecond = ticksPerSecond;
        this.updatesPerTick = updatesPerTick;
