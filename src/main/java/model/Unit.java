...
public class Unit {
    ...
    public model.Vec2Double getSize() {
        return size;
    }

    public void setSize(model.Vec2Double size) {
        this.size = size;
    }

    private model.JumpState jumpState;

    public model.JumpState getJumpState() {
        return jumpState;
    }

    public void setJumpState(model.JumpState jumpState) {
    ...
    public void setWeapon(model.Weapon weapon) {
        this.weapon = weapon;
    }
    ...
    public Unit(int playerId, int id, int health, model.Vec2Double position, model.Vec2Double size,
                model.JumpState jumpState, boolean walkedRight, boolean stand, boolean onGround, boolean onLadder,
                int mines, model.Weapon weapon) {
        this.playerId = playerId;
        this.id = id;
        this.health = health;
        this.position = position;
