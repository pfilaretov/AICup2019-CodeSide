...
public class UnitAction {
    ...
    public model.Vec2Double getAim() {
        return aim;
    }

    public void setAim(model.Vec2Double aim) {
        this.aim = aim;
    }
    ...
    public UnitAction(double velocity, boolean jump, boolean jumpDown, model.Vec2Double aim, boolean shoot,
                      boolean reload, boolean swapWeapon, boolean plantMine) {
        this.velocity = velocity;
        this.jump = jump;
        this.jumpDown = jumpDown;
        this.aim = aim;
