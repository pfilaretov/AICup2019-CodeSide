...
public class Weapon {
    ...
    public model.WeaponType getTyp() {
        return typ;
    }

    public void setTyp(model.WeaponType typ) {
        this.typ = typ;
    }

    private model.WeaponParams params;

    public model.WeaponParams getParams() {
        return params;
    }

    public void setParams(model.WeaponParams params) {
        this.params = params;
    }
    ...
    public Weapon(model.WeaponType typ, model.WeaponParams params, int magazine, boolean wasShooting, double spread,
                  Double fireTimer, Double lastAngle, Integer lastFireTick) {
        this.typ = typ;
        this.params = params;
        this.magazine = magazine;
        this.wasShooting = wasShooting;
