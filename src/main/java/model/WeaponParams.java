...
public class WeaponParams {
    ...
    public model.BulletParams getBullet() {
        return bullet;
    }

    public void setBullet(model.BulletParams bullet) {
        this.bullet = bullet;
    }

    private model.ExplosionParams explosion;

    public model.ExplosionParams getExplosion() {
        return explosion;
    }

    public void setExplosion(model.ExplosionParams explosion) {
    ...
    public WeaponParams(int magazineSize, double fireRate, double reloadTime, double minSpread, double maxSpread,
                        double recoil, double aimSpeed, model.BulletParams bullet, model.ExplosionParams explosion) {
        this.magazineSize = magazineSize;
        this.fireRate = fireRate;
        this.reloadTime = reloadTime;
        this.minSpread = minSpread;
